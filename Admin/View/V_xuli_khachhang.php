	...
	<div class="">
		...
		<div class="row">
			...
			<div class="col-9 mt-2">
				...
				<div class="col-md-9">
					<form action="?controller=xuli_khachhang&method=edit&id_kh=<?php echo $_GET['id_kh'] ?>" method="post">
						<div class="row mt-5">
						<h5 class="text col-md-2">Họ tên</h5>
						<input type="text" name="name" class="form-control col-md-6" value="<?php echo $data_khachhang[0]['name'] ?>">
					</div>
					<div class="row mt-5">
						<h5 class="text col-md-2">SDT</h5>
						<input type="number" name="sdt" class="form-control col-md-6" value="<?php echo $data_khachhang[0]['sdt'] ?>">
					</div>
					<div class="row mt-1">
					...
					<div class="row mt-5">
						...
						<input type="email" name="email" class="form-control col-md-6" value="<?php echo $data_khachhang[0]['email'] ?>">
					</div>
					<div class="row mt-5">
						<h5 class="text col-md-2">Địa chỉ</h5>
						<input type="text" name="Diachi" class="form-control col-md-6" value="<?php echo $data_khachhang[0]['Diachi'] ?>">
					</div>
					<div class="row mt-5">
