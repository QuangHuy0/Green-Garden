						...
						<table class="table">
						  ...
						  <tbody>
						    <tr>
						      ...
						      <td class="text-center border border-info align-middle"><?php echo $value['gia'] ?></td>
						      <td class="text-center border border-info align-middle"><?php echo $value['soluongsp'] ?></td>
						      
						      <td class="text-center border border-info align-middle"><?php echo $value['gia']*$value['soluongsp'] ?>
						      </td>
