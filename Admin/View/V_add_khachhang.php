	...
	<div class="">
		...
		<div class="row">
			...
			<div class="col-9 mt-2">
				...
				<div class="col-7">
				<form action="?controller=add_khachhang" method="post">
					<div class="row mt-5">
						<h5 class="text-dark col-md-2">Họ tên</h5>
					...
					<div class="row mt-5">
						...
						<input type="number" name="sdt" class="form-control col-md-6" value="<?php echo (isset($sdt))?$sdt:'' ?>">
					</div>
					<div class="row mt-1">
					...
					<div class="row mt-5">
						<h5 class="text-dark col-md-2">Địa chỉ</h5>
						<input type="text" name="Diachi" class="form-control col-md-6" value="<?php echo (isset($diachi))?$diachi:'' ?>">
					</div>
					<div class="row mt-5">
						<button type="submit" style="background-color:#0C7E02;" class="col-md-3 btn m-auto text-white" name="btn_create">Thêm khách hàng</button>
					</div>
				</form>
				</div>
			</div>
