	...
	<div class="">
		...
		<div class="row">
			...
			<div class="col-9 mt-2">
				...
				<div class="col-7">
				<form action="?controller=add_danhmuc" method="post" enctype="multipart/form-data">
					<div class="row mt-5">
						<h5 class="text-dark col-md-3">Tên danh mục</h5>
						<input type="text" name="tendm" class="form-control col-md-6" value="<?php echo (isset($tendm))?$tendm:'' ?>">
					</div>
					<div class="row mt-1">
					...
					<div class="row mt-5">
						<button type="submit" style="background-color:#0C7E02;" class="col-md-3 btn m-auto text-white" name="btn_createdm">Thêm danh mục</button>
					</div>
				</form>
				</div>
			</div>
